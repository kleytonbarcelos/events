...
$dadosboleto["nosso_numero1"] = rand(1,9).rand(1,9).rand(1,9);//"000"; // tamanho 3
$dadosboleto["nosso_numero_const1"] = "2"; //constanto 1 , 1=registrada , 2=sem registro
$dadosboleto["nosso_numero2"] = rand(1,9).rand(1,9).rand(1,9);//"000"; // tamanho 3
$dadosboleto["nosso_numero_const2"] = "4"; //constanto 2 , 4=emitido pelo proprio cliente
$dadosboleto["nosso_numero3"] = $this->pedido['numero']; // tamanho 9
