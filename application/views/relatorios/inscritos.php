<h4><i class="fa fa-th-list"></i> Relatório - Todos inscritos</h4>
...
>
	<thead>
		<tr>
			...
			<th data-sortable="true" data-halign="center" data-formatter="sumFormatter">Valor (R$)</th>
		</tr>
	</thead>
	<tbody>
		<?php
			...
			foreach ($dados as $key => $value)
			{
				...
				echo '
					<tr>
						...
						<td>'.$value->email.'</td>
						<td>'.$status.'</td>
						<td>'.decimal_to_br($value->dados_fatura->valor).'</td>
					</tr>
				';
