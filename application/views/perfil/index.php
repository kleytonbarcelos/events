<?=form_open('Perfil/salvar', array('id'=>'formPerfil', 'role'=>'form'))?>
	<div class="msg"></div>
	<div role="tabpanel">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group form-group-sm">
							...
							<input type="text" class="form-control" id="txtNome" name="txtNome" data-field-db="<?=sha1('nome')?>" placeholder="Nome" value="<?=set_value('txtNome')?>">
					...
					<div class="col-md-4">
						<div class="form-group form-group-sm">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="txtEmail" name="txtEmail" data-field-db="<?=sha1('email')?>" placeholder="E-mail" value="<?=set_value('txtEmail')?>">
							</div>
							<small class="msg-erro text-danger"></small>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group form-group-sm">
							...
							<input type="text" class="form-control inputmask-telefone" id="txtPessoaProximaTelefone" name="txtPessoaProximaTelefone" data-field-db="<?=sha1('clientes.pessoaproximatelefone')?>" placeholder="Telefone" value="<?=set_value('txtPessoaProximaTelefone')?>">
							<small class="msg-erro text-danger"></small>
						</div>
					</div>
					<div class="col-md-2">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group form-group-sm">
							...
							<select class="form-control" id="txtCamisa" name="txtCamisa" data-field-db="<?=sha1('camisa')?>"><!--  data-live-search="false" data-style="btn-default btn-sm"> -->
								<option value=""></option>
