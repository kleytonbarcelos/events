																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Recuperação de senha</h3>
										                                            <br>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
										                                                ...
										                                                <br><br>
																						Foi solicitado uma recuperação de senha para sua conta. Clique no link abaixo para concluir essa operação.
																						<br><br>
																						<a href="http://www.inscricaosegura.com/login/novasenha/<?php echo $key;?>" target="_blank">http://www.inscricaosegura.com/login/novasenha/<?php echo $key;?></a>
																						<br><br>
																						<em>*Caso você não tenha feito tal solicitação favor desconsiderar esta mensagem.</em>
																						<br><br><br>
																...
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;">
																			<br>
																			<div><em>Copyright &copy; <?=date('Y')?>, Todos direitos reservados.</em></div>
																			<br>
																		</div>
