																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
										                                                ...
										                                                <br><br>
																						Seu cadastro foi realizado com sucesso no evento: <? echo $evento; ?>. Realize o pagamento ainda hoje, acessando seu <strong>Painel de Controle</strong>, clique no link  <strong>Minhas inscrições</strong> e imprima seu boleto.
																						<br><br>
																						Site: <a href="http://www.inscricaosegura.com/boletos/imprimir/<?php echo $boleto; ?>" target="_blank"><strong>www.inscricaosegura.com/boletos/imprimir/<?php echo $boleto; ?></strong></a>
																						<br>
