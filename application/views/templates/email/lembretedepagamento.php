						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#d3d3d3">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
													...
													<tr>
														<td align="center" valign="top" width="600" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="middle" class="imageContent">
																		<img src="http://inscricaosegura.com/assets/img/email/topo.jpg">
																	</td>
																</tr>
															</table>
															<table border="0" cellpadding="30" cellspacing="0" width="100%" bgcolor="#fff">
																<tr>
																	<td align="center" valign="top">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Lembrete de pagamento</h3>
										                                            <br />
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
										                                                ...
										                                                <br /><br />
																						Identificamos que sua inscrição ainda não foi paga. Realize o pagamento ainda hoje, acessando seu <strong>Painel de Controle</strong>, clique no link  <strong>Minhas inscrições</strong> e imprima seu boleto.
																						<br /><br />
																						Lembramos que os valores e vantagens serão atualizados de acordo com o lote vigênte nesta data.
																						<br><br />
																						Site: <a href="http://www.inscricaosegura.com" target="_blank"><strong>www.inscricaosegura.com</strong></a>
																						<br />
																						E-mail: <?php echo $email;?>
																						<br />
																						Senha: *******
																						<br><br>Caso já tenha pago o boleto. Favor desconsiderar esta mensagem.
																						<br><br><br>
																						Conte sempre conosco.
																						<br><br>
																						<strong>Inscrição Segura.com</strong>
																					</div>
																				</td>
																			</tr>
																		</table>
																...
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;">
																			<br />
																			<div><em>Copyright &copy; <?php echo date('Y'); ?>, Todos direitos reservados.</em></div>
																			<br />
																		</div>
